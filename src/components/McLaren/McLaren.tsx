...
// Updated paths for McLaren images
import mclarenLogo from '../../assets/images/mclaren_green_logo.jpg';
import mclaren720S from '../../assets/images/mclaren_720_S.png';
import mclarenSenna from '../../assets/images/mclaren_senna.jpg';
import mclarenSennaGTR from '../../assets/images/mclaren_senna_gtr.png';
...
// Updated McLaren models data
const carModels: CarModel[] = [
  { name: 'McLaren Senna GTR', image: mclarenSenna, price: '$2,700,000' },
  { name: 'McLaren 720S', image: mclaren720S, price: '$308,000' },
  { name: 'McLaren Senna GTR', image: mclarenSennaGTR, price: '$2,695,000' },
];
    ...
    <Box sx={{
      ...
      <Container maxWidth="xl" sx={{ mt: '-32px', overflow: 'hidden', mb: '200px' }}>
        <div style={{
          width: '100%',
          height: '150px',
          backgroundImage: `url(${mclarenLogo})`,
